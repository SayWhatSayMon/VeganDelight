...
public class ModItems {
    ...
    public static final RegistryObject<Item> TOFU = ITEMS.register("tofu",
            () -> new Item(new Item.Properties().tab(ModCreativeTabs.VEGAN_TAB).food(new FoodProperties.Builder()
                    .nutrition(4)
                    .saturationMod(0.4f)
                    .build())));
    ...
    public static final RegistryObject<Item> SALT = ITEMS.register("salt",
            () -> new Item(new Item.Properties().tab(ModCreativeTabs.VEGAN_TAB)));
    ...
    public static final RegistryObject<Item> SOYBEAN = ITEMS.register("soybean",
            () -> new ItemNameBlockItem(ModBlocks.SOYBEAN_CROP.get(),
                    new Item.Properties().tab(ModCreativeTabs.VEGAN_TAB).food(new FoodProperties.Builder()
                            .nutrition(1)
                            .saturationMod(0.1f)
                            .build())));
